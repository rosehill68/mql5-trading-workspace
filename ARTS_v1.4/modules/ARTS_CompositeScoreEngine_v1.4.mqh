//+------------------------------------------------------------------+
//|                     ARTS_CompositeScoreEngine_v1.4.mqh           |
...
private:
   ...
   double CalculateTrendEntryScore(double price, double breakout_level, bool is_long)
   {
      double score = 0;
      double point = SymbolInfoDouble(_Symbol, SYMBOL_POINT);
      // FIX v1.4: Use indicators with default bar 1
      ...
      // FIX v1.4: Use bar 1 for high/low
   ...
   {
      // FIX v1.4: Use bar 1 for volume (non-repainting)
