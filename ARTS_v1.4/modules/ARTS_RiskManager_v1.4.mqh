...
public:
   ...
   {
      // FIX v1.4: Input validation
      m_risk_percent = (risk_percent > 0 && risk_percent <= 10.0) ? risk_percent : 0.7;
      m_max_daily_drawdown = (max_daily_dd > 0 && max_daily_dd <= 20.0) ? max_daily_dd : 1.5;
      m_max_trades_per_day = (max_trades > 0 && max_trades <= 100) ? max_trades : 3;
   ...
   double CalculatePositionSize(string symbol, double entry_price, double stop_loss)
   {
      ...
      // FIX v1.4: Strict validation for sl_pips
