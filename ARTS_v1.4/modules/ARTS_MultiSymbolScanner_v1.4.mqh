//+------------------------------------------------------------------+
//|                       ARTS_MultiSymbolScanner_v1.4.mqh           |
...
#include "ARTS_RegimeDetector_v1.4.mqh"
#include "ARTS_IndicatorLibrary_v1.4.mqh"
#include "ARTS_CompositeScoreEngine_v1.4.mqh"
#include "ARTS_MarketActivityAnalyzer_v1.4.mqh"
#include "ARTS_NewsAndSpreadGuard_v1.4.mqh"
#include "ARTS_SignalManager_v1.4.mqh"
#include "ARTS_RiskManager_v1.4.mqh"
...
private:
   ...
   {
      // FIX v1.4: Use bar 1 for indicators
      ...
      // FIX v1.4: Use bar 1 for confirmed closed price
      ...
      // FIX v1.4: Use bar 1 for entry price (confirmed close)
      double entry = iClose(symbol, PERIOD_H1, 1);
   ...
   bool ScanTrendSignal(string symbol, SymbolSignal &output)
   {
      ...
      // FIX v1.4: Use bar 1 and 2 for confirmed closes
      double current_price_h1 = iClose(symbol, PERIOD_H1, 1);
