...
public:
   ...
   bool OpenPosition(TradingSignal &signal, bool use_trailing_tp)
   {
      ...
      bool result = m_trade.PositionOpen(signal.symbol, order_type, signal.position_size, price, sl, tp, "ARTS v1.4");
...
private:
   ...
   {
      // FIX v1.4: Check bounds before adding
      if(m_tracked_count >= 100) 
      {
         Print("WARNING: Position tracker full! Max 100 positions.");
         return;
      }
